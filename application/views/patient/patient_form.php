                ...
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label for="firstname" class="col-xs-3 col-form-label">Matric Number <i class="text-danger">*</i></label>
                            <div class="col-xs-9">
                                <input name="patient_id" type="text" class="form-control" id="matric" placeholder="Matric Number" value="<?php echo $patient->patient_id ?>">
                            </div>
                        </div>
