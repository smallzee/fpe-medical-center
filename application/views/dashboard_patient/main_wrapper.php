            ...
            <aside class="main-sidebar">
                ...
                <div class="sidebar">
                    ...
                    <ul class="sidebar-menu"> 
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(2) == "appointment") ? "active" : null) ?>">
                            <a href="#">
                                <i class="fa fa-edit"></i><span><?php echo display('appointment') ?></span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu"> 
                                <li><a href="<?php echo base_url("dashboard_patient/appointment/appointment/create") ?>"><?php echo display('add_appointment') ?></a></li> 
                                <li><a href="<?php echo base_url("dashboard_patient/appointment/appointment") ?>"><?php echo display('appointment_list') ?></a></li> 
                            </ul>
                        </li>
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(2) == "message") ? "active" : null) ?>">
                            ...
                            <ul class="treeview-menu">
                                <li class="<?php echo (($this->uri->segment(2) == "message" && $this->uri->segment(3) == "new_message")? "active" : null) ?>"><a href="<?php echo base_url("dashboard_patient/message/new_message") ?>"> <?php echo display('new_message') ?> </a></li> 
                               
                                <li class="<?php echo (($this->uri->segment(2) == "message" && $this->uri->segment(3) == "")? "active" : null) ?>"><a href="<?php echo base_url("dashboard_patient/message") ?>"> <?php echo display('inbox') ?> </a></li> 
                                <li class="<?php echo (($this->uri->segment(2) == "message" && $this->uri->segment(3) == "sent")? "active" : null) ?>"><a href="<?php echo base_url("dashboard_patient/message/sent") ?>"><?php echo display('sent') ?> </a></li>
