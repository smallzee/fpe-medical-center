           <div class="header-slider header-slider-preloader" id="header-slider">
                ...
                <?php
                   if(!empty($sliders)){
                    ...
                    ?>
                    <!-- Slide 1-->
                    <div class="item" style="background-image: url(<?= (!empty($slider->image)?base_url($slider->image):base_url('assets/images/dummy.jpg'))?>);">
...
<!--                                                    </a>-->
                 ...
                 <?php }elseif($slider->position==2){?>
                    <!-- Slide 2-->
                    <div class="item" style="background-image: url(<?= (!empty($slider->image)?base_url($slider->image):base_url('assets/images/bg.jpg'))?>);">
                        <div class="slide-table">
                            <div class="slide-tablecell">
                                <div class="container">
                                    <div class="row">
