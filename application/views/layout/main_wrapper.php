...
<!--    </li>-->
    ...
    <li class="treeview <?php echo (($this->uri->segment(1) == "pharmacy") ? "active" : null) ?>">
        ...
        <ul class="treeview-menu">
            ...
            ?>
            <li class="<?php echo (($this->uri->segment(1) == "pharmacy" && $this->uri->segment(2) == "medicine" && $this->uri->segment(3) == "index")? "active" : null) ?>"><a href="<?php echo base_url('pharmacy/medicine/index') ?>"><?php echo display('medicine_list') ?></a></li>
            <?php } ?>
