                                ...
                                <tr>
                                    <th width="33.33%">
                                        <ul class="list-unstyled">
                                            <li>
                                                <input type="text" placeholder="Matric Number *" required name="patient_id" id="patient_id" class="invoice-input form-control" value="<?php echo (!empty($patient_id)?$patient_id:null) ?>">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        if (!empty($subsub) && sizeof($subsub) > 0)
                                                                           $k=0; foreach ($subsub as $value) {
                                                                          ?>
                                                                        <div class="checkbox checkbox-success text-success">
                                                                            <input type="checkbox" value="<?= $value->value;?>" name="sub_cat_name[<?= $i?>][]" id="subsub<?= $subitem->id.$k;?>">
                                                                            <label for="subsub<?= $subitem->id.$k;?>"> <?= $value->value;?></label>
                                                                         </div>
                                                                         <?php $k++; }?>
                                                                    </div>
